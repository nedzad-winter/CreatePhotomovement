...
public class HorizontalSolarGeneratorScenes {
    ...
    public static void dyeing(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        // Animate Standard
        builder.world().setBlock(standardPos, AllBlocks.BLUE_HORIZONTAL_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.world().setBlock(advancedPos, AllBlocks.BLUE_HORZ_ADV_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.idle(20);

        builder.world().setBlock(standardPos, AllBlocks.RED_HORIZONTAL_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.world().setBlock(advancedPos, AllBlocks.RED_HORZ_ADV_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.idle(20);

        builder.world().setBlock(standardPos, AllBlocks.YELLOW_HORIZONTAL_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.world().setBlock(advancedPos, AllBlocks.YELLOW_HORZ_ADV_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.idle(20);

        builder.world().setBlock(standardPos, AllBlocks.LIME_HORIZONTAL_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.world().setBlock(advancedPos, AllBlocks.LIME_HORZ_ADV_SOLAR_GENERATOR.defaultBlockState()
                .setValue(net.minecraft.world.level.block.state.properties.BlockStateProperties.HORIZONTAL_FACING,
                        Direction.NORTH),
                true);
        builder.idle(30);
