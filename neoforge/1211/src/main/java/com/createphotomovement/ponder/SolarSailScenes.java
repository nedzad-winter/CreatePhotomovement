...
public class SolarSailScenes {
    ...
    public static void basics(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        builder.world().setBlock(sailPos, AllBlocks.BLUE_SOLAR_SAIL.get().defaultBlockState()
        ...
        // Replace a column
        builder.world().replaceBlocks(util.select().fromTo(2, 2, 1, 2, 4, 1), AllBlocks.BLUE_SOLAR_SAIL.get()
                .defaultBlockState()
                .setValue(BlockStateProperties.FACING, Direction.WEST), false);
