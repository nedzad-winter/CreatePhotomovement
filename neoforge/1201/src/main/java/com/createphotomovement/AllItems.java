...
public class AllItems {
        ...
        public static final RegistryObject<BlockItem> LIGHT_BLUE_HORIZONTAL_SOLAR_GENERATOR = ITEMS.register(
                        ...
                        () -> new BlockItem(AllBlocks.LIGHT_BLUE_HORIZONTAL_SOLAR_GENERATOR.get(),
                                        new Item.Properties()));
        ...
        public static final RegistryObject<BlockItem> LIGHT_GRAY_HORIZONTAL_SOLAR_GENERATOR = ITEMS.register(
                        ...
                        () -> new BlockItem(AllBlocks.LIGHT_GRAY_HORIZONTAL_SOLAR_GENERATOR.get(),
                                        new Item.Properties()));
        ...
        public static final RegistryObject<BlockItem> ADV_SOLAR_GENERATOR = ITEMS.register(
                        "adv_solar_generator",
                        () -> new BlockItem(AllBlocks.ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        // Advanced Solar Generator Color Variants
        public static final RegistryObject<BlockItem> WHITE_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "white_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.WHITE_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> ORANGE_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "orange_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.ORANGE_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> MAGENTA_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "magenta_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.MAGENTA_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> LIGHT_BLUE_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "light_blue_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.LIGHT_BLUE_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> YELLOW_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "yellow_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.YELLOW_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> LIME_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "lime_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.LIME_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> PINK_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "pink_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.PINK_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> GRAY_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "gray_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.GRAY_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> LIGHT_GRAY_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "light_gray_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.LIGHT_GRAY_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> CYAN_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "cyan_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.CYAN_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> PURPLE_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "purple_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.PURPLE_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> BLUE_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "blue_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.BLUE_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> BROWN_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "brown_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.BROWN_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> GREEN_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "green_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.GREEN_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> RED_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "red_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.RED_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> BLACK_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "black_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.BLACK_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        // Horizontal Advanced Solar Generator Color Variants
        public static final RegistryObject<BlockItem> WHITE_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "white_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.WHITE_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> ORANGE_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "orange_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.ORANGE_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> MAGENTA_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "magenta_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.MAGENTA_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> LIGHT_BLUE_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "light_blue_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.LIGHT_BLUE_HORZ_ADV_SOLAR_GENERATOR.get(),
                                        new Item.Properties()));

        public static final RegistryObject<BlockItem> YELLOW_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "yellow_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.YELLOW_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> LIME_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "lime_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.LIME_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> PINK_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "pink_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.PINK_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> GRAY_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "gray_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.GRAY_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> LIGHT_GRAY_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "light_gray_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.LIGHT_GRAY_HORZ_ADV_SOLAR_GENERATOR.get(),
                                        new Item.Properties()));

        public static final RegistryObject<BlockItem> CYAN_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "cyan_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.CYAN_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> PURPLE_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "purple_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.PURPLE_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> BLUE_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "blue_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.BLUE_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> BROWN_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "brown_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.BROWN_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> GREEN_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "green_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.GREEN_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));

        public static final RegistryObject<BlockItem> RED_HORZ_ADV_SOLAR_GENERATOR = ITEMS.register(
                        "red_horz_adv_solar_generator",
                        () -> new BlockItem(AllBlocks.RED_HORZ_ADV_SOLAR_GENERATOR.get(), new Item.Properties()));
