...
public class AllBlockEntityTypes {
        ...
        public static final RegistryObject<BlockEntityType<HorizontalSolarGeneratorBlockEntity>> HORIZONTAL_SOLAR_GENERATOR = BLOCK_ENTITY_TYPES
        ...
        @SuppressWarnings("DataFlowIssue")
        public static final RegistryObject<BlockEntityType<SolarGeneratorBlockEntity>> SOLAR_GENERATOR = BLOCK_ENTITY_TYPES
                        .register("solar_generator",
                                        () -> BlockEntityType.Builder.of(
                                                        (pos, state) -> new SolarGeneratorBlockEntity(
                                                                        AllBlockEntityTypes.SOLAR_GENERATOR.get(), pos,
                                                                        state),
        ...
        @SuppressWarnings("DataFlowIssue")
        public static final RegistryObject<BlockEntityType<AdvSolarGeneratorBlockEntity>> ADV_SOLAR_GENERATOR = BLOCK_ENTITY_TYPES
        ...
        @SuppressWarnings("DataFlowIssue")
        public static final RegistryObject<BlockEntityType<HorzAdvSolarGeneratorBlockEntity>> HORZ_ADV_SOLAR_GENERATOR = BLOCK_ENTITY_TYPES
